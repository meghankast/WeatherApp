...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseCoreInternal-macOS/FirebaseCoreInternal.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseInstallations-macOS/FirebaseInstallations.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities-macOS/GoogleUtilities.framework"
